...
while True:
    user_input = input("Enter three %servo [escpwm, pan, steer] seperated by a space, or \"q\" to quit: ") 
    if user_input == 'q':
        break


    pwm, pan, steer = [float(i) for i in user_input.split(' ')]
