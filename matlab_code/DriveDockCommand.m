classdef DriveDockCommand  < Command
    ...
    methods
        ...
        function obj = DriveDockCommand(rover_handle, DrivetrainController,waypoint_list, end_dist_tolerance,linear_velocity,final_position,dock_apriltag_distance)
            ...
            obj.dock_apriltag_distance = dock_apriltag_distance;
        ...
        function execute(obj)
            ...
            if obj.dock_apriltag_distance > max_distance
